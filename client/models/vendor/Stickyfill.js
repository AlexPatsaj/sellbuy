...
/** 
*
*   Addapted from https://github.com/wilddeer/stickyfill 
*
*   Please remember that sticky elements will stick, therefore they should have height < page height 
*   This polyfill scrolls them along with their parent component.. so if we did not have infinit scroll layouts it would work with 
*   comp height > window height, but most our pages are for ever growing.. 
*/ 
 ...
 *    We also modified this to be encapsulated in a function which checks if the window object is defined. 
 *    This way we can get around the Server Side Rendering BullSH***
 */

function doSeppuku(){ 
    if(typeof(window) == 'undefined') { return true; } //SSR nothing to do here 
...
let seppuku = doSeppuku();

if(seppuku){
    console.log("The sticky polyfill cannot work with this browser ");
}
...
if (typeof module != 'undefined' && module.exports) {
    module.exports = typeof(window) !=='undefined' ? Stickyfill : null;
}
else {
