...
import { ENDPOINT_FOLLOWING_LIST } from 'models/Endpoints';
    ...
    return (
      <Layout>
        ...
        <ProfileLayout active="friends">
          <FriendsBox active="following" users={list} onUnfollow={onUnfollow} />
        </ProfileLayout>
        <Footer/>
      </Layout>
    )
...
const mapDispatchToProps = (dispatch) => ({
  searchFriends: () => dispatch(searchFriends(ENDPOINT_FOLLOWING_LIST)),
